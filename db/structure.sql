...
--
-- Name: index_comments_on_listing_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_comments_on_listing_id ON comments USING btree (listing_id);
...
--
-- Name: index_on_listings_location; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_on_listings_location ON listings USING gist (st_geographyfromtext((((('SRID=4326;POINT('::text || longitude) || ' '::text) || latitude) || ')'::text)));
...
INSERT INTO schema_migrations (version) VALUES ('20140310174940');

INSERT INTO schema_migrations (version) VALUES ('20140311001019');

INSERT INTO schema_migrations (version) VALUES ('20140311174551');

INSERT INTO schema_migrations (version) VALUES ('20140311210003');

INSERT INTO schema_migrations (version) VALUES ('20140311221351');
